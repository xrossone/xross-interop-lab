...
//! 用法：
//! ```text
//! xinterop-demo [run|discovery|session|sink|media|qshare|mirror|dlna|wfd] [--json]
//! ```
...
fn usage() {
    eprintln!("用法：xinterop-demo [run|discovery|session|sink|media|qshare|mirror|dlna|wfd] [--json]");
